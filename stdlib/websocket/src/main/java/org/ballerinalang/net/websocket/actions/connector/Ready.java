...
/**
 * {@code Ready} is the Ready action implementation of the WebSocket Connector.
 */
@BallerinaFunction(
...
public class Ready implements NativeCallableUnit {
    ...
    public void execute(Context context, CallableUnitCallback callback) {
        ...
        if (!isReady) {
            ...
            context.setReturnValues(BLangVMErrors.createError(context, "Already started reading frames"));
        }
