...
package org.ballerinalang.net.websocket.websocketclientendpoint;
...
@BallerinaFunction(
        orgName = "ballerina", packageName = WebSocketConstants.WEBSOCKET, functionName = "initEndpoint",
        receiver = @Receiver(type = TypeKind.OBJECT, structType = WebSocketConstants.WEBSOCKET_CLIENT_ENDPOINT,
...
public class InitEndpoint extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        HttpWsConnectorFactory connectorFactory = WebSocketUtil.createHttpWsConnectionFactory();
