...
public class WebSocketConnectorPortBindingListener implements PortBindingEventListener {
    ...
    public void onOpen(String serverConnectorId, boolean isHttps) {
        if (isHttps) {
            console.println(WebSocketConstants.WSS_ENDPOINT_STARTED + serverConnectorId);
        } else {
            console.println(WebSocketConstants.WS_ENDPOINT_STARTED + serverConnectorId);
        }
    }
    ...
    public void onClose(String serverConnectorId, boolean isHttps) {
        if (isHttps) {
            console.println(WebSocketConstants.WSS_ENDPOINT_STOPPED + serverConnectorId);
        } else {
            console.println(WebSocketConstants.WS_ENDPOINT_STOPPED + serverConnectorId);
        }
    }
