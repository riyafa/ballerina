 ...
 */
package org.ballerinalang.net.websocket.compiler;
...
import static org.ballerinalang.net.websocket.WebSocketConstants.WEBSOCKET_CLIENT_SERVICE;
import static org.ballerinalang.net.websocket.WebSocketConstants.WEBSOCKET_SERVICE;
                ...
                if (annotations.size() > 1) {
                    ...
                    for (AnnotationAttachmentNode annotation : annotations) {
                        if (annotation.getAnnotationName().getValue().equals(
                                WebSocketConstants.ANN_NAME_SERVICE_CONFIG)) {
                            count++;
                        }
                    }
                    if (count > 1) {
