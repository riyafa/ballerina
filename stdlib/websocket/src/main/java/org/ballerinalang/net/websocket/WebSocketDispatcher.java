...
public class WebSocketDispatcher {
    ...
    static WebSocketService findService(WebSocketServicesRegistry servicesRegistry,
        ...
        try {
            ...
            serviceUri = WebSocketUtil.sanitizeBasePath(serviceUri);
            ...
            msg.setProperty(WebSocketConstants.QUERY_STR, requestUri.getRawQuery());
            msg.setProperty(WebSocketConstants.RESOURCE_ARGS, pathParams);
            return service;
                ...
                case TypeTags.ARRAY_TAG:
                    if (((BArrayType) dataType).getElementType().getTag() == TypeTags.BYTE_TAG) {
                        bValues[1] = new BByteArray(
                                aggregateString.getBytes(Charset.forName(WebSocketConstants.UTF_8)));
                    }
                    break;
                default:
