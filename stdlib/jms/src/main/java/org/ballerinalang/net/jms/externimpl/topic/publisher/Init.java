...
public class Init {
    ...
    public static Object init(Strand strand, ObjectValue topicPublisherObj, MapValue<String, Object> config) {
        return ProducerInitHandler.handle(topicPublisherObj, config);
    }
