...
package org.ballerinalang.net.jms.externimpl.message;
    ...
    public static Object getHeaders(Strand strand, ObjectValue msgObj) {
        ...
        try {
            ...
            if (deliveryMode == DeliveryMode.PERSISTENT) {
                headersRecord.put(DELIVERY_MODE, JmsConstants.PERSISTENT);
            } else {
                headersRecord.put(DELIVERY_MODE, JmsConstants.NON_PERSISTENT);
            }
