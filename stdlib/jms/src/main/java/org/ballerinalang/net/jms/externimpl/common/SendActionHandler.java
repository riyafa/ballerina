...
public class SendActionHandler {
    ...
    public static Object handle(ObjectValue sender, ObjectValue msgObj, MapValue<String, Object> config) {
...
//            sessionConnector.handleTransactionBlock(context);
            messageProducer.send(message, JmsUtils.getDeliveryMode(config),
