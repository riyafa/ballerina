...
public class JmsConstants {
    ...
    public static final String CONSUMER_OBJ_NAME = "Consumer";
    ...
    public static final String QUEUE_PRODUCER_OBJ_NAME = "QueueProducer";
    ...
    public static final String JMS_ERROR_CODE = "{" + PROTOCOL_PACKAGE_JMS + "}Error";
    ...
    private static final String PARAM_CONNECTION_FACTORY_JNDI_NAME = "transport.jms.ConnectionFactoryJNDIName";
    private static final String PARAM_CONNECTION_FACTORY_TYPE = "transport.jms.ConnectionFactoryType";
    private static final String PARAM_DESTINATION_NAME = "transport.jms.Destination";
    private static final String PARAM_ACK_MODE = "transport.jms.SessionAcknowledgement";
    private static final String PARAM_DURABLE_SUB_ID = "transport.jms.DurableSubscriberName";
    private static final String PARAM_CLIENT_ID = "transport.jms.DurableSubscriberClientId";
    ...
    public static final String TIME_TO_LIVE = "timeToLiveInMilliSeconds";
