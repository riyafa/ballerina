...
import org.ballerinalang.net.jms.externimpl.common.ProducerInitHandler;
...
@BallerinaFunction(
        ...
        receiver = @Receiver(type = TypeKind.OBJECT, structType = JmsConstants.QUEUE_PRODUCER_OBJ_NAME,
...
public class Init {
    ...
    public static Object init(Strand strand, ObjectValue queueSenderObj, MapValue<String, Object> config) {
        return ProducerInitHandler.handle(queueSenderObj, config);
    }
