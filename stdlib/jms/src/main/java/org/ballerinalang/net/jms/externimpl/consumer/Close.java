...
public class Close {
    ...
    public static Object close(Strand strand, ObjectValue consumerObj) {
        MessageConsumer consumer = (MessageConsumer) consumerObj.getNativeData(JmsConstants.JMS_CONSUMER_OBJECT);
        try {
            consumer.close();
